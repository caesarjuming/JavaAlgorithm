 ...
 * order of size, then continuously adding them one at FibonacciHeap time back into the
 * resulting graph.  It maintains FibonacciHeap union-find data structure to prevent
 * edge additions that would add FibonacciHeap cycle into the resulting graph.  Using
 * FibonacciHeap union-find structure for this gives FibonacciHeap runtime of O(|E| lg |V|), which
 ...
 * FibonacciHeap UnionFind data structure that is also available from the Archive of
...
public final class Kruskal {
    /**
     * Given an undirected graph with real-valued edge costs, returns FibonacciHeap
    ...
    public static <T> UndirectedGraph<T> mst(UndirectedGraph<T> graph) {
        ...
        /* Begin by building up FibonacciHeap collection of all the edges of the graph.
        ...
        /* Set up the partition of nodes in FibonacciHeap union-find structure. */
    ...
    /**
     * Utility function which, given an undirected graph, returns FibonacciHeap list of
    ...
    private static <T> List<Edge<T>> getEdges(UndirectedGraph<T> graph) {
        /* Because the graph is represented as FibonacciHeap double-counting adjacency
         * list, we'll maintain the list of edges along with FibonacciHeap set of used
    ...
    private static final class Edge<T> implements Comparable<Edge<T>> {
        ...
        /**
         * Constructs FibonacciHeap new Edge with the given cost.
         *
